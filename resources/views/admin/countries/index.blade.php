...
<div class="p-6">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Countries</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Manage countries and their settings</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <dt class="text-sm font-medium text-gray-500">Total Countries</dt>
                    <dd class="text-2xl font-bold text-gray-900">{{ $countries->total() }}</dd>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <dt class="text-sm font-medium text-gray-500">Active Countries</dt>
                    <dd class="text-2xl font-bold text-gray-900">{{ $countries->where('is_active', true)->count() }}</dd>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <dd class="text-2xl font-bold text-gray-900">{{ $countries->sum('users_count') ?? 0 }}</dd>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <dt class="text-sm font-medium text-gray-500">With Currency</dt>
                    <dd class="text-2xl font-bold text-gray-900">{{ $countries->whereNotNull('currency_code')->count() }}</dd>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Codes</th>
                    ...
                    @forelse($countries as $country)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    @if($country->flag_url)
                                        <img class="h-6 w-8 mr-3 object-cover rounded" src="{{ $country->flag_url }}" alt="{{ $country->name }} flag">
                                    @else
                                        <div class="h-6 w-8 mr-3 bg-gray-200 rounded flex items-center justify-center">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <svg class="mx-auto h-12 w-12 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    ...
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.8 13.8a7 7 0 1 1-11.5 0"/>
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 10h.01M15 10h.01"/>
                                </svg>
