...
<div class="p-6">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Edit Country</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Update country information</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <form action="{{ route('admin.countries.update', $country) }}" method="POST" class="divide-y divide-gray-200">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               id="code_2"
                               name="code_2"
                               value="{{ old('code_2', $country->code_2) }}"
                               maxlength="2"
            ...
            <div class="px-6 py-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        @if($country->flag_url)
                            <div class="mt-2">
                                <p class="text-sm text-gray-700 mb-1">Current flag:</p>
                                <img src="{{ $country->flag_url }}" alt="{{ $country->name }} flag" class="h-8 w-12 object-cover rounded border">
                            </div>
                        @endif
                    </div>
            ...
            <div class="px-6 py-6 bg-gray-50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="bg-white rounded-lg p-4 border">
                        ...
                        <dd class="text-2xl font-bold text-gray-900">{{ $country->users_count ?? 0 }}</dd>
                    </div>
                    <div class="bg-white rounded-lg p-4 border">
                        <dt class="text-sm font-medium text-gray-500">Created</dt>
                        <dd class="text-sm text-gray-900">{{ $country->created_at->format('M j, Y') }}</dd>
                    </div>
                    <div class="bg-white rounded-lg p-4 border">
                        <dt class="text-sm font-medium text-gray-500">Last Updated</dt>
                        <dd class="text-sm text-gray-900">{{ $country->updated_at->format('M j, Y') }}</dd>
                    </div>
                </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="mt-1 text-sm text-blue-700">
                                    ...
                                    Disabling this country may affect these users' profiles.
                                </p>
                            </div>
                        </div>
                    </div>
