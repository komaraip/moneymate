...
func seedTransactionsAndPrices(ctx context.Context, db *pgxpool.Pool, userID string) error {
	transactions := []struct {
		...
		{"2026-06-10", "etf", ptr("SPY"), "S&P 500 ETF", "buy", 733.33, 0.075204887, 55.15841734, "USD", ptrFloat(17933.4939)},
		...
		{"2026-06-25", "etf", ptr("SPY"), "S&P 500 ETF", "buy", 735.72, 0.037418923, 27.53213609, "USD", ptrFloat(17935.0305)},
