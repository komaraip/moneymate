				...
				<div class="row">
                           				...
                           				<div class="container-kom">
											<div class="details">
												<?php
													...
													if($fetch['profile'] == ''){
														echo '<img src="uploaded/default.jpg">';
													} else {
														echo '<img src="uploaded/'.$fetch['profile'].'" width="240">';
													}
												?>
											</div>

											<li class="nav-item">
												<a href="update-1.php" class="btn btn-primary d-sm-inline-block d-none">Update Details</a>
											</li>
										</div>
								...
								<div class="d-sm-flex d-block">
									<ul class="card-list d-flex mt-sm-0 mt-3">
                           				...
                           				<div class="container-kom">
											...
											<li class="nav-item">
												<a href="update-2.php" class="btn btn-primary d-sm-inline-block d-none">Update Details</a>
											</li>
										</div>
					...
					<div class="col-xl-12 col-xxl-4">
						<div class="card box-shadow-none">
							<div class="card-header d-flex flex-wrap border-0 pb-0">
								<div class="me-auto mb-sm-0 mb-3">
									<h4 class="card-title mb-2">Finance</h4>
								</div>
							</div>
							...
							<div class="card-body pb-2">
								<div class="d-sm-flex d-block">
									<ul class="card-list d-flex mt-sm-0 mt-3">
                           				<div class="container-kom">
											<div class="details-kom">
												<p>Card     	    : <?=$_SESSION['card'];?></p>
												<p>Card	Number	    : <?=$_SESSION['cardnumber'];?></p>
												<p>Balance          : <?=$_SESSION['balance'];?></p>
												<p>Balance Limit    : <?=$_SESSION['balance_limit'];?></p>
												<p>Currency 	    : <?=$_SESSION['currency'];?></p>
											</div>

											<li class="nav-item">
												<a href="update-3.php" class="btn btn-primary d-sm-inline-block d-none">Update Details</a>
											</li>
										</div>
									</ul>
								</div>								
