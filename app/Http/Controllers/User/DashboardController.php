...
class DashboardController extends Controller
{
    ...
    public function financial()
    {
        ...
        return view('user.dashboard.financial', compact(
            'user',
            'recentTransactions',
            'spendingByCategory',
            'totalIncome',
    ...
    public function account()
    {
        ...
        $cardNames = CardNameCategory::active()->orderBy('name')->get();
        $cardTypes = CardTypeCategory::active()->orderBy('name')->get();
        $currencies = Currency::active()->orderBy('code')->get();

        return view('user.dashboard.account', compact(
            'user',
            'countries',
            'cardNames',
            'cardTypes',
    ...
    public function updateAccount(Request $request)
    {
        ...
        $request->validate([
            ...
            'country' => 'nullable|exists:country_categories,id',
            'card_name' => 'nullable|exists:card_name_categories,id',
            'card_type' => 'nullable|exists:card_type_categories,id',
        ]);
